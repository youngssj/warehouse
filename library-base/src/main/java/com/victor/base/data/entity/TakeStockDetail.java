...
public class TakeStockDetail {
    ...
    private List<ElecMaterialListDTO> elecMaterialList;

    @Entity
    public static class ElecMaterialListDTO {
    ...
    public List<ElecMaterialListDTO> getElecMaterialList() {
        return elecMaterialList;
    }

    public void setElecMaterialList(List<ElecMaterialListDTO> elecMaterialList) {
