...
//            onDayTapped(new CalendarDay(System.currentTimeMillis()));
    ...
    private void initData() {
        ...
        if (dataModel.leastDaysNum > dataModel.mostDaysNum) {
            throw new IllegalArgumentException(mContext.getResources().getString(R.string.calendar_days_warning));
        }
        ...
        if (dataModel.defTag == null) {
            dataModel.defTag = mContext.getResources().getString(R.string.calendar_tag);
        }
...
//        v.reuse();
    ...
    private void singleSelectedDay(CalendarDay calendarDay) {
        ...
        if (rangeDays.getFirst() != null && rangeDays.getFirst().equals(calendarDay)) {
            ...
            mController.onDateSelected(null);
            notifyDataSetChanged();
            return;
        }
        //如果日期被占用
...
//            return getDate().compareTo(calendarDay.getDate());
            if (calendarDay == null) {
                throw new IllegalArgumentException(BaseApplication.getInstance().getResources().getString(R.string.calendar_compare_warning));
            }
