...
public class DayPickerView extends RecyclerView {
    ...
    public DayPickerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        typedArray = context.obtainStyledAttributes(attrs, R.styleable.calendar_DayPickerView);
...
//            Log.e("crash", "请设置参数");
    ...
    public void scrollToSelectedPosition(SimpleMonthAdapter.SelectedDays<SimpleMonthAdapter.CalendarDay> selectedDays, int monthStart, int yearStart) {
        try {
            int position = 0;
