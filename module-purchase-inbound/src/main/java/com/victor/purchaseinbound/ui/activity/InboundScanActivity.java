...
import com.victor.purchaseinbound.databinding.PurchaseinboundScanActivityBinding;
import com.victor.purchaseinbound.ui.viewmodel.InboundScanViewModel;
...
@Route(path = RouterActivityPath.PurchaseInbound.PAGER_INBOUND_SCAN)
public class InboundScanActivity extends BaseUhfActivity<PurchaseinboundScanActivityBinding, InboundScanViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.purchaseinbound_scan_activity;
    }
