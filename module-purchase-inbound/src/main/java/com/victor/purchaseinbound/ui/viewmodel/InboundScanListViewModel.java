...
import com.victor.purchaseinbound.bean.InboundScanItemsBean;
import com.victor.purchaseinbound.ui.viewmodel.itemviewmodel.InboundScanItemViewModel;
...
public class InboundScanListViewModel extends BaseViewModel {
    ...
    public ItemBinding<InboundScanItemViewModel> inboundScanItemBinding = ItemBinding.of(BR.viewModel, R.layout.purchaseinbound_item_scan);
