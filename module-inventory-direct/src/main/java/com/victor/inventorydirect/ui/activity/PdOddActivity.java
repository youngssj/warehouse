...
import com.victor.inventorydirect.databinding.InventorydirectFragmentPdOddBinding;
...
public class PdOddActivity extends MBaseActivity<InventorydirectFragmentPdOddBinding, PdOddViewModel> {

    @Override
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.inventorydirect_fragment_pd_odd;
    }
