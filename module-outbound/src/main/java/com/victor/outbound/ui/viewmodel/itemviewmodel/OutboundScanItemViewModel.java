...
public class OutboundScanItemViewModel extends ItemViewModel<OutboundScanListViewModel> {
    ...
    public ObservableField<OutboundData.OutboundElecMaterial> entity = new ObservableField<>();

    public BindingCommand itemClick = new BindingCommand(() -> {
        viewModel.uc.showCustomEvent.setValue(this);
    });

    public OutboundScanItemViewModel(@NonNull OutboundScanListViewModel viewModel, OutboundData.OutboundElecMaterial bean) {
        super(viewModel);
